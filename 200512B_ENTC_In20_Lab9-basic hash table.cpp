...
struct HashTable{
	...
	//add an if condition to complete the code here
        if (empty){
            ...
            cout << "User " << user_name << " is inserted.\n";
        } else {
	...
	//add an if condition to complete the code here
        if (empty){
            cout << "No password is found for the user " << user_name << ".\n";
        } else {
            cout << "The password for the user " << user_name << " is " << password[hash] << ".\n";
        }
    ...
    void delete_item(string user_name){
        ...
        if(empty){
            ...
            password[hash].clear();
            cout<<"The user " << user_name << " is deleted.\n";
        }
